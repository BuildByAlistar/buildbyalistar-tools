...
export const toolCategories = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: "Manage saved templates, drafts, favorites, and archived outputs.",
        status: "Live",
        route: "/templates/library",
        badge: "Library",
      },
      {
        name: "AI Invitation Studio",
        description: "Build dynamic event invitations with AI copy, layouts, and shareable HTML export.",
        status: "Live",
        route: "/templates/invitation-generator",
        badge: "New",
      },
      {
        name: "AI Email Studio",
        description: "Create inbox-ready emails with dynamic blocks, AI writing, and HTML export.",
        status: "Live",
        route: "/templates/email-generator",
        badge: "New",
      },
      {
      ...
      },
      {
        ...
        description: "Build premium portfolio pages with projects, visuals, case studies, testimonials, and strong contact CTAs.",
        status: "Soon",
        badge: "Template",
      },
    ],
